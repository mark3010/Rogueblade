...
function draw_me(a,b,c) {
	...
	var shape = [[55*(1-animation)*scale,0],[0,55*(1-animation)*scale],[-55*(1-animation)*scale,0],[0,-55*(1-animation)*scale]]
	//var col = c_white
	var width = 2
	...
	draw_sprite_ext(spr_light,0,x,y-zPosition,(1-animation)*scale,(1-animation)*scale,direction,bladeCol,.3*(1-alpha))
