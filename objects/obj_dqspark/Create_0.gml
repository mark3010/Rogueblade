...
function draw_me(sliceSurf, effectSurf, targetSurf) {
	...
	draw_sprite_ext(sprite_index,irandom(sprite_get_number(sprite_index)),x,y-zPosition,image_xscale,image_yscale,direction,merge_color(color,c_black,colorVar),1)
